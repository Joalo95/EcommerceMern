        ...
        <div className="placeorder">
            ...
            <div className="informations-placeorder">
                ...
                <div>
                    ...
                    {cart.cartItems.length === 0 ? <p>Tu carrito está vacío</p> :
            ...
            <div className="your-products">
                ...
                <div className="cart-summ">
                    ...
                    <div className="calculs-placeorder">
                        <h3>Artículos: </h3><p>${cart.itemsPrice}</p>
                        <h3>Envío: </h3><p>${cart.shippingPrice}</p>
                        <h3>Impuestos: </h3><p>${cart.taxPrice}</p>
                        <h3>Total: </h3><p>${cart.totalPrice}</p>
                        <div className="div-placeorder-btn">
                            <button className="placeorder-btn" onClick={Placeorderhanlder}>Confirmar Pedido</button>
                            {error && error}
                        </div>
                    </div>
