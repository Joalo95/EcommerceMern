...
const Edituser = ({ match, history }) => {
  ...
  return (
    <div className='Edituser'>
      ...
      {successUpdate && <h4>Perfil Actualizado</h4>}
      {loading || loadingUpdate ?
        ...
        : error ? <h4>{error}</h4> :
          <div>
            <h4 className='Edittitle'>Editar Usuario :</h4>
              ...
              <form onSubmit={submitHandler}>
                ...
                <div >
                  ...
                  <div className="input-div pass">
                    <div className="div">
                      <Checkbox isChecked={isAdmin} onChange={(e) => { setisAdmin(e.target.checked); console.log(isAdmin) }}>Es Administrador</Checkbox>
                    </div>
                  </div>
