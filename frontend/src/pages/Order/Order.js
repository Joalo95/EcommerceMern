                ...
                <div className="informations-placeorder">
                    <div className="shipping-placeorder">
                        ...
                        <p>
                            ...
                            {order.isDelivered ? <div className='paid'>Entregado el {order.deliveredAt}</div> : <div className='notpaid'>Entrega pendiente</div>}
                    ...
                    <div className="payment-placeorder">
                        ...
                        <p>
                            ...
                            {order.paymentMethod}
                            {order.isPaid ? <div className='paid'>Pago el {order.paidAt}</div> : <div className='notpaid'>Pago pendiente</div>}
                        </p>
                    </div>
                    <hr className='hr' />
                    <div>
                        <h2>Artículos del pedido: </h2>
                        {order.orderItems.length === 0 ? <p>Tu pedido está vacío</p> :
                ...
                <div className="your-products">
                    ...
                    <div className="cart-summ">
                        ...
                        <div className="calculs-placeorder">
                            <h3>Artículos: </h3><p>${order.itemsPrice}</p>
                            <h3>Envío: </h3><p>${order.shippingPrice}</p>
                            <h3>Impuestos: </h3><p>${order.taxPrice}</p>
                    ...
                    <div className='bottominfos'>
                        <h1 className='orderid'>Pedido : {order._id}</h1>
                        {!order.isPaid && (
                            <>
                        ...
                        {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
                            <Button height="40px" width="200px"
                                size="lg" onClick={deliverhandler} leftIcon={<IoMdDoneAll size='16' />} colorScheme='blue' >ENTREGADO</Button>
                        )}
