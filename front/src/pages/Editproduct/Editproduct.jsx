        ...
        <div className='Edituser'>
            ...
            {loading || lodingUpdate ?
                ...
                : errorUpdate ? <h4>{errorUpdate}</h4> :
                    <div>
                        <h4 className='Edittitle'>Editar Producto :</h4>
                            ...
                            <form onSubmit={submitHandler}>
                                ...
                                <div >
                                    ...
                                    <div className="input-div one">
                                        ...
                                        <div className="div">
                                            <InputGroup>
                                                <Input type="text" value={countInStock} placeholder="cantidad" onChange={(e) => setcountInStock(e.target.value)} />
                                            </InputGroup>
                                    ...
                                    <div className="input-div one">
                                        ...
                                        <div className="div">
                                            <Stack direction='column' spacing={4}>
                                                <InputGroup>
                                                    <Textarea size='sm' value={description} placeholder="descripción" onChange={(e) => setdescription(e.target.value)} />
                                                </InputGroup>
                                                <Stack direction="row">
                                                    <Checkbox onChange={() => { checkboxhandlercg('Men'); setMenselected(!Menselected) }} isChecked={Menselected}>Hombre </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('Women'); setWomenselected(!Watchesselected) }} isChecked={Womenselected}>Dama </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('Bag'); setBagselected(!Bagselected) }} isChecked={Bagselected}>Bolsos </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('Watches'); setWatchesselected(!Watchesselected) }} isChecked={Watchesselected}>Relojes </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('Shoes'); setShoesselected(!Shoesselected) }} isChecked={Shoesselected}>Zapatos </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('Jacket'); setJacketselected(!Jacketselected) }} isChecked={Jacketselected}>Abrigos </Checkbox>
                                                </Stack>
                                            </Stack>
                                        </div>
                                    ...
                                    <input type="submit" className="btna2 postionbtnupdate" value="Actualizar" />
