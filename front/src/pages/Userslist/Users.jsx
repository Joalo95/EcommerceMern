...
const Users = ({ history }) => {
    ...
    return (
        <div className='Users'>
            ...
            <h1 className='titlepanel'> Usuarios :</h1>
                        ...
                        <Table className='tableusers' variant="striped">
                            <Thead>
                                <Tr>
                                    ...
                                    <Th textAlign='center' w='20%'>Nombre</Th>
                                    <Th textAlign='center' w='50%'>Correo</Th>
                                    ...
                                    <Tr key={user._id}>
                                        ...
                                        <Td>
                                            <Stack>
                                                ...
                                                <Button colorScheme='red' leftIcon={<AiFillDelete size='16' />} size="xs" onClick={() => { deletehandler(user._id) }}>ELIMINAR</Button>
                                            </Stack>
                                        </Td>
