...
const Orders = ({ history }) => {
    ...
    return (
        <div className='Users'>
            ...
            <h1 className='titlepanel'> Órdenes :</h1>
                        ...
                        <Table className='tableusers' variant="striped">
                            <Thead>
                                <Tr>
                                    ...
                                    <Th textAlign='center' w='20%'>Usuario</Th>
                                    <Th textAlign='center' w='20%'>Fecha</Th>
                                    <Th textAlign='center' w='5%'>Total</Th>
                                    <Th textAlign='center' w='10%'>Pago</Th>
                                    <Th textAlign='center' w='10%'>Entregado</Th>
                                        ...
                                        <Td>
                                            <Stack>
                                                <Link to={`/order/${order._id}`}>
                                                    <Button leftIcon={<AiOutlineEdit size='16' />} colorScheme='blue' size="xs"  >Detalles</Button>
                                                </Link>
                                            </Stack>
                                        </Td>
