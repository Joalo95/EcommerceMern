...
import { IoLogOutOutline, IoChevronDownCircleOutline, IoMdArrowDropdown, IoCloseOutline } from "react-icons/io"
import logo from './img/logo-baibai.png';
    ...
    return (
        <nav ref={Nav} className={`nav ${nav ? 'active' : ''}`} >
            ...
            <ul className="navLinks" ref={navLinks}>
                <NavLink to="/" exact activeClassName='activlink' ><li>Menu principal</li></NavLink>
                <NavLink to="/shop" activeClassName='activlink' ><li>Tienda</li></NavLink>
                <NavLink to="/contactus" activeClassName='activlink' ><li>Contáctanos</li></NavLink>
                <NavLink to="/about" activeClassName='activlink'><li>Sobre nosotros</li></NavLink>
            </ul>
            ...
            <div className="rightComp" ref={rightItems}>
                ...
                ) : <Link to='/login' > <div className='signin' onMouseOver={() => setSignin(!signin)} onMouseOut={() => setSignin(!signin)}  > Iniciar Sesión
